...
BOOL CALLBACK EnumWindowsProc(HWND hwnd, LPARAM lParam)
{
	...
	if (written && strstr(buffer, "Cheat Engine") != NULL) {
		*(HWND*)lParam = hwnd;
		cheating = true;
		return FALSE;
	}
